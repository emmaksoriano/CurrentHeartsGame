...
View.OnClickListener {
	 ...
	 * 
	 * @return a new, game-specific instance of a sub-class of the HeartsLocalGame
	 *         class.
	 */
...
//		}
	...
	protected void initTableRows() {
		...
		for (int i = 0; i < numPlayers; ++i) {
			...
			// set up our spinner so that when its last element ("Network HeartsPlayer") is selected,
	...
	private static class SpinnerListListener implements OnItemSelectedListener {
		...
		// the position in the spinner of the "Network HeartsPlayer" selection
		 ...
		 * 			the TextView object
		 * @param idxNum
		 * 			the index of the "Network HeartsPlayer" item in the spinner
		 */
